...
def supprimer_entree(table):
    ...
    aSupprimer = input(
        "Entrez le numéro " + printDeSerie(table) + const.getSingularTableName(table) + " à supprimer : ")
    ...
    if table == "Personnes":
        print(
            "Attention la suppression d'une personne entraine la suppression de tous ses appareils ainsi que les réparations associées à ces appareils")
    if table == "Appareils":
        print(
            "Attention la suppression d'un appareil entraine la suppression de toutes les réparations associées à cet appareil")
    if table == "Evenements":
        print(
            "Attention la suppression d'un évènement entraine la suppression de toutes les réparations associées à cet évènement")
    if table == "ModeleAppareils":
        print(
            "Attention la suppression d'un modèle entraine la suppression de tous les appareils associés à ce modèle ainsi que les réparations associées à ces appareils")
